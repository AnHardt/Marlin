...
.\bdf2u8g.exe -b 32 -e 127 ISO10646-1.bdf ASCII_5x7 dogm_font_data_ASCII.h
...
.\bdf2u8g.exe -b 32 -e 255 ISO10646-1-pl.bdf ISO10646_1_PL_5x7 dogm_font_data_ISO10646_1_PL.h